      ...
      if (error) {
        ...
        mytable.get("SELECT COUNT(*) as count FROM movies", (err, result) => {
          if (err) {
            ...
            // Add sample movies to reach at least 10
            const sampleMovies = [
              {
                title: "The Godfather",
                year: 1972,
      ...
      if (error) {
        ...
        mytable.get("SELECT COUNT(*) as count FROM reviews", (err, result) => {
          if (err) {
            ...
            // Add sample reviews to reach at least 10
            const sampleReviews = [
      ...
      if (error) {
        ...
        mytable.get("SELECT COUNT(*) as count FROM users", (err, result) => {
          if (err) {
            ...
            // Add sample users to reach at least 10
            const sampleUsers = [
              {
      ...
      if (error) {
        ...
        mytable.get("SELECT COUNT(*) as count FROM rentals", (err, result) => {
          if (err) {
            ...
            // Add sample rentals to reach at least 10
            const sampleRentals = [
