...
Josue Galindo - gajoyr25@student.ju.se
          ...
          if (err) {
            ...
            const sampleMovies = [
              ...
              },
              {
                ...
                runtimeMinutes: 121,
                rating: 8.6,
                posterUrl: "/img/posters/newhope.jpg",
              ...
              },
              {
                ...
                runtimeMinutes: 152,
                rating: 9.0,
                posterUrl: "/img/posters/darkknight.jpg",
              ...
              },
              {
                ...
                runtimeMinutes: 116,
                rating: 8.5,
                posterUrl: "/img/posters/backtothefuture.jpg",
              ...
              },
              {
                ...
                runtimeMinutes: 127,
                rating: 8.1,
                posterUrl: "/img/posters/jurassic.jpg",
              ...
              },
              {
                ...
                runtimeMinutes: 118,
                rating: 8.6,
                posterUrl: "/img/posters/silencelambs.jpg",
              ...
              },
              {
                ...
                runtimeMinutes: 178,
                rating: 8.8,
                posterUrl: "/img/posters/fellowship.jpg",
      ...
      if (error) {
        ...
        mytable.get("SELECT COUNT(*) as count FROM reviews", (err, result) => {
          if (err) {
            ...
            const sampleReviews = [
              {
                movieId: 1, // Star Wars: A New Hope
                userId: 1,
                rating: 10,
              ...
              {
                movieId: 3, // Back to the Future
                userId: 3,
                rating: 9,
                comment: "Time travel done right. So much fun!",
                date: "2024-02-01",
              },
              {
                movieId: 4, // Jurassic Park
                userId: 1,
                rating: 8,
                comment: "Dinosaurs never looked so good!",
                date: "2024-02-10",
              },
              {
              ...
              {
                movieId: 7, // The Silence of the Lambs
                userId: 1,
                rating: 10,
              ...
              {
                movieId: 9, // The Lord of the Rings: The Fellowship of the Ring
                userId: 3,
                rating: 10,
                comment: "Epic fantasy adventure that changed cinema forever.",
                date: "2024-03-20",
              },
              {
                movieId: 10, // Inception
                userId: 1,
                rating: 9,
                comment: "Mind-bending thriller that makes you think.",
                date: "2024-03-25",
              },
              {
                movieId: 11, // The Matrix
                userId: 2,
                rating: 10,
...
function initTableGenres(mytable) {
  ...
  mytable.run(
    `CREATE TABLE IF NOT EXISTS genres (genreId INTEGER PRIMARY KEY, genreName TEXT UNIQUE)`,
    (error) => {
      if (error) {
  ...
  mytable.run(
    ...
    (error) => {
      if (error) {
        ...
        mytable.get(
          "SELECT COUNT(*) as count FROM movie_genres",
          (err, result) => {
            if (err) {
...
app.get("/admin/users/edit/:id", (req, res) => {
  ...
  db.get(
    "SELECT userId, username, isAdmin FROM users WHERE userId = ?",
    [userId],
    (error, user) => {
      if (error) {
...
app.post("/admin/users/update/:id", (req, res) => {
  ...
  if (password && password.trim() !== "") {
    ...
    db.run(
      "UPDATE users SET username = ?, isAdmin = ? WHERE userId = ?",
      [username, isAdminValue, userId],
      (error) => {
        if (error) {
          console.log("Error updating user:", error);
        } else {
